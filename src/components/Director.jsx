    ...
    <section id="directeur" className="director">
      <div className="container">
        <div className="director__inner">
          {/* Colonne gauche : bulle + photo empilées */}
          <div className="director__col-visual">
            <div className="director__bubble-wrap">
              <div className="director__comic-bubble" aria-hidden="true">
                <span className="emoji">💬</span> N'oubliez pas de rester
                connectés sur nos
                ...
                régulièrement organisées pour rassembler les familles, partager
                des moments de convivialité et créer des souvenirs inoubliables
                ensemble <span className="emoji">✨</span>
              </div>
            </div>
